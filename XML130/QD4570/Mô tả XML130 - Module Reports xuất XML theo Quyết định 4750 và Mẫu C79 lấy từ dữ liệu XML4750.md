...
|32|t_bntt|`=bang1.t_bntt + bang1.t_bncct`|`=bang1.t_bntt + bang1.t_bncct`|NUMERIC(15,2)|Số tiền người bệnh thanh toán (Ghi số tiền người bệnh chi trả bao gồm cùng chi trả tự trả khi khám bệnh chữa bệnh không đúng tuyến số tiền tự trả đối với các dịch vụ y tế áp dụng tỷ lệ thanh toán)|
