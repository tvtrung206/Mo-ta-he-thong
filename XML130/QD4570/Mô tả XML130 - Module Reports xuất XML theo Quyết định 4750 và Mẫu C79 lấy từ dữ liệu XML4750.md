...
|22|t_cdha|NUMERIC(15,2)|Tiền chẩn đoán hình ảnh và thăm dò chức năng|`=SUM(bang3.thanh_tien_bh)` đối với `bang3.ma_nhom = 2`|`=SUM(bang3.thanh_tien_bh)` đối với `bang3.ma_nhom = 2`|
