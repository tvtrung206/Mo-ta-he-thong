...
|39|ma_loaikcb|VARCHAR(2)|Mã hóa hình thức KCB: (1: khám bệnh; 2: điều trị ngoại trú; 3: điều trị nội trú)|Xét giá trị cột:`bang1.ma_loai_kcb`[^2024-09-13-02]<br/>➡️`('01','05','07','08')`: `ma_loaikcb = '1'`<br/>➡️`('02')`: `ma_loaikcb = '2'`<br/>➡️`('03','09')`: `ma_loaikcb = '3'`|`=bang1.ma_loai_kcb`|
