...
|4|ngay_sinh|VARCHAR(12)|Ngày sinh ghi trên thẻ gồm 8 ký tự; 4 ký tự năm + 2 ký tự tháng + 2 ký tự ngày (nếu không có ngày sinh thì ghi năm sinh: 4 ký tự)|`ngay_sinh=LEFT(bang1.ngay_sinh,8)`[^2024-09-06-01]. Riêng đối với người bệnh chỉ có năm sinh `ngay_sinh=LEFT(bang1.ngay_sinh,4)`[^2024-09-13-01]|
...
|18|ket_qua_dtri|NUMERIC(1,0)|Kết quả điều trị: Mã hóa (1: Khỏi; 2: Đỡ; 3: Không thay đổi; 4: Nặng hơn; 5: Tử vong)|Xét giá trị cột:`bang1.ket_qua_dtri`[^2024-09-13-03]<br/>➡️`(1)`: `ket_qua_dtri = 1`<br/>➡️`(2)`: `ket_qua_dtri = 2`<br/>➡️`(3, 7)`: `ket_qua_dtri = 3`<br/>➡️`(4, 6)`: `ket_qua_dtri = 4`<br/>➡️`(5, 8)`: `ket_qua_dtri = 5`|
...
|39|ma_loaikcb|VARCHAR(2)|Mã hóa hình thức KCB: (1: khám bệnh; 2: điều trị ngoại trú; 3: điều trị nội trú)|Xét giá trị cột:`bang1.ma_loai_kcb`[^2024-09-13-02]<br/>➡️`('01','05','07','08')`: `ma_loaikcb = '1'`<br/>➡️`('02')`: `ma_loaikcb = '2'`<br/>➡️`('03','09')`: `ma_loaikcb = '3'`|
...
Dữ liệu xuất file Excel Công văn 3360/BHXH-CSYT, do BHXH Việt Nam ban hành ngày 04 tháng 09 năm 2015: Cập nhật mẫu Excel từ Cổng giám định BHYT ngày 27/8/2019, cụ thể:
STT	Chỉ tiêu	Kiểu dữ liệu (theo QĐ4750)	Diễn giải (CV3360)	Ghi chú
1	stt	NUMERIC(10,0)	Số thứ tự bệnh nhân từ 1 đến hết	
2	ma_bn	VARCHAR(100)	Mã số BN quy định tại CSKCB	=bang1.ma_bn
3	ho_ten	VARCHAR(255)	Họ tên người bệnh viết bằng chữ thường.	=bang1.ho_ten
