...
|12|tomtat_kq|VARCHAR|  X|Ghi tóm tắt kết quả xét nghiệm cận lâm sàng có giá trị chẩn đoán.||- Đối với bệnh án ngoại trú (quyết toán cuối đợt): `tomtat_kq = tongketba.kqxetnghiem`.<br/>- Đối ới bệnh án nội trú: `tomtat_kq = bnnoitru.tomtat_kq`. [^2024-06-30-06] [^2024-07-11-02]|
