...
:white_check_mark: **Điều kiện xuất dữ liệu XML130:** Dữ liệu bảng này phải phát sinh ở table `current.psgiamdinhykhoa`. [^2024-06-30]
...
|4|ho_ten|VARCHAR(255)| X |Ghi họ và tên người được giám định y khoa.||`= dmbenhnhan.holot + “ ” + dmbenhnhan.ten`<br/><br/>tham chiếu `psgiamdinhykhoa.mabn = dmbenhnhan.mabn`|
|5|ngay_sinh|VARCHAR(8)| X |Ghi ngày, tháng, năm sinh của người được giám định y khoa, theo định dạng yyyymmdd||`= to_char(dmbenhnhan.ngaysinh,’yyyyMMdd’)`<br/><br/>tham chiếu `psgiamdinhykhoa.mabn = dmbenhnhan.mabn`|
...
|15|nghe_nghiep|VARCHAR(100)||Ghi nghề nghiệp của người đề nghị khám giám định y khoa (nếu có).||`= dmnghe.tennghe`<br/>Tham chiếu `psgiamdinhykhoa.mabn = dmbenhnhan.mabn và dmbenhnhan.manghe = dmnghe.manghe`|
|16|dien_thoai|VARCHAR(15)| X |Ghi số điện thoại liên hệ của người đề nghị giám định y khoa||`= dmbenhnhan.dienthoai`|
